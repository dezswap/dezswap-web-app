...
interface DisclaimerModalProps extends Pick<ReactModal.Props, "isOpen"> {
  onAgree?: () => void;
}

function DisclaimerModal({ isOpen, onAgree }: DisclaimerModalProps) {
  const theme = useTheme();

  const handleSubmit: React.FormEventHandler<HTMLFormElement> = (event) => {
    event.preventDefault();
    const formData = new FormData(event.currentTarget);
    if (formData.get("agreement") === "on" && onAgree) {
      onAgree();
    }
  };
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <BoldContent>
            ...
            providing liquidity on Dezswap is at your own risk, without
          ...
          <Content>
            ...
            XPLA Chain, that allows users to trade certain compatible digital
            assets (“the Dezswap protocol” or the “Protocol”). The Interface is
            ...
            which allows you to interact with the XPLA Chain. Your relationship
            with that non-custodial wallet provider is governed by the
            applicable terms of service of that third party, not this Agreement.
            Wallets are not operated by, maintained by, or affiliated with us,
            and we do not have custody or control over the contents of your
            wallet and have no ability to retrieve or transfer its contents. By
            connecting your wallet to our Interface, you agree to be bound by
            this Agreement and all of the terms incorporated herein by
            reference.
            <br />
            <br />
          </Content>
          ...
          <Content>
            ...
            contracts that are deployed on the XPLA Chain. We do not operate the
            Protocol on the XPLA Chain. By using the Interface, you understand
            that you are not buying or selling digital assets from us and that
            we do not operate any liquidity pools on the Protocol or control
            trade execution on the Protocol. When traders pay fees for trades,
            those fees accrue to liquidity providers for the Protocol. As a
            general matter, we are not a liquidity provider into Protocol
            liquidity pools and liquidity providers are independent third
            parties. The Protocol was deployed on the XPLA Chain. Please note
            that digital assets that have been “bridged” or “wrapped” to operate
            on other blockchain networks are distinct from the original XPLA
            mainnet asset.
            <br />
            <br />
          </Content>
          <BoldContent>Eligibility</BoldContent>
          <Content>
            ...
            by the relevant authorities of the Republic of Korea, the United
            States, the United Kingdom, or the European Union; or (b) a citizen,
            ...
            economic sanctions by the Republic of Korea, the United States, the
            United Kingdom, the European Union or other relevant jurisdictions.
            Finally, you represent that your access and use of the Interface
          ...
          <Content>
            ...
            of ours:
            <br />
            (a) with or without notice to you, to modify, substitute, eliminate
            or add to the Interface; (b) to review, modify, filter, disable,
            delete and remove any and all content and information from the
            Interface; and (c) to cooperate with any law enforcement, court or
          ...
          <Content>
            ...
            blockchain, which is the XPLA Chain. As a result, we do not (and
            cannot) guarantee market best pricing or best execution through the
            Interface or when using our Auto Routing feature, which routes
            trades across liquidity pools on the Protocol only. Any references
            in the Interface to “best price” do not constitute a representation
            or warranty about pricing available through the Interface, on the
          ...
          <Content>
            ...
            verified token lists hosted at assets.xpla.io/cw20/tokens.json and
            assets.xpla.io/ibc/tokens.json). We may also provide verified labels
            or warning dialogs for certain tokens. The provision of
            informational materials does not make trades in those tokens
            solicited; we are not attempting to induce you to make any purchase
            as a result of the information provided. All such information
            provided by the Interface is for informational purposes only and
            should not be construed as investment advice or a recommendation
            that a particular token is a safe or sound investment. You should
            not take, or refrain from taking, any action based on any
            information contained in the Interface. By providing token
          ...
          <Content>
            ...
            operate with any specific wallet. Likewise, you are solely
          ...
          <Content>
            ...
            jurisdiction. By accessing or using the Interface, you agree that
          ...
          <Content>
            ...
            and intricacies of digital assets such as XPLA, so-called
          ...
          <Content>
            ...
            losses, liabilities, costs, and expenses arising from: <B>(a)</B>{" "}
            ...
            <B>(c)</B> any other party&apos;s access and use of the Interface
            with your assistance or using any device or account that you own or
            control.
            <br />
            <br />
          </Content>
          ...
          <Content>
            ...
            risk, and without warranties of any kind. No developer or entity
            involved in creating the Protocol will be liable for any claims or
            damages whatsoever associated with your use, inability to use, or
            your interaction with other users of, the Protocol, including any
          ...
          <ItalicContent>
            ...
            IT. WE ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY: <B>(A)</B>{" "}
            ERRORS, MISTAKES, OR INACCURACIES OF CONTENT; <B>(B)</B> PERSONAL
            INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM
            ANY ACCESS OR USE OF THE INTERFACE; <B>(C)</B> UNAUTHORIZED ACCESS
            OR USE OF ANY SECURE SERVER OR DATABASE IN OUR CONTROL, OR THE USE
            OF ANY INFORMATION OR DATA STORED THEREIN; <B>(D)</B> INTERRUPTION
            OR CESSATION OF FUNCTION RELATED TO THE INTERFACE; <B>(E)</B> BUGS,
            VIRUSES, TROJAN HORSES, OR THE LIKE THAT MAY BE TRANSMITTED TO OR
            THROUGH THE INTERFACE; <B>(F)</B> ERRORS OR OMISSIONS IN, OR LOSS OR
            DAMAGE INCURRED AS A RESULT OF THE USE OF, ANY CONTENT MADE
            AVAILABLE THROUGH THE INTERFACE; AND <B>(G)</B> THE DEFAMATORY,
          ...
          <Content>
            ...
            contact@dezswap.io so that we can attempt to resolve it without
            ...
            accordance with the International Arbitration Rules of the Korean
            Commercial Arbitration Board(KCAB Rules). The number of arbitrators
            shall be three. The seat, or legal place, of arbitral proceedings
            shall be Seoul/Republic of Korea. The language to be used in the
            arbitral proceedings shall be English. Unless we agree otherwise,
            the arbitrator may not consolidate your claims with those of any
          ...
          <BoldContent>Governing Law</BoldContent>
          <Content>
